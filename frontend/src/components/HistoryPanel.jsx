...
function HistoryPanel({ onSelectHistory }) {
  ...
  return (
    <div className="relative border border-cyan-500/30 bg-gray-900/80 backdrop-blur-sm"
      ...
      <div className="p-4 border-b border-cyan-500/30">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-bold text-cyan-400 uppercase tracking-wide font-mono">
              {t('historyTitle')}
            </h3>
          ...
          <div className="flex items-center gap-2">
            {history.length > 0 && (
              <>
                <button
                  ...
                  className="px-3 py-1 text-xs bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-400 border border-cyan-500/50 rounded font-mono transition-all flex items-center gap-1"
                ...
                <button
                  ...
                  className="px-3 py-1 text-xs bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/50 rounded font-mono transition-all flex items-center gap-1"
            ...
            <button
              ...
              className="px-3 py-1 text-xs bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-400 border border-cyan-500/50 rounded font-mono transition-all flex items-center"
            >
            ...
            <div className="divide-y divide-cyan-500/10">
              {history.map((item) => (
                <div
                  ...
                  className="p-4 hover:bg-cyan-500/10 hover:border-l-4 hover:border-l-cyan-400 hover:shadow-lg hover:shadow-cyan-500/20 cursor-pointer transition-all group relative"
                >
                  {/* Indicador de clickeable */}
                  <div className="absolute top-4 right-4 transition-all">
                    <span className="text-sm text-gray-400 group-hover:text-cyan-400 font-mono group-hover:scale-110 inline-flex items-center gap-1 transition-all">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0 pr-12">
                      ...
                      {/* Ubicación */}
                      <div className="text-sm text-gray-300 font-mono mb-1 break-words flex items-center gap-1">
                      ...
                      {/* Fecha del evento */}
                      <div className="text-sm text-cyan-400 font-mono mt-1 flex items-center gap-1">
                    ...
                    <div className="flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity absolute bottom-4 right-4">
                      <button
                        ...
                        className="px-2 py-1 text-xs bg-cyan-500/20 hover:bg-cyan-500/40 text-cyan-400 border border-cyan-500/50 rounded font-mono hover:scale-110 transition-all"
                        title="JSON"
                      >
                      ...
                      <button
                        ...
                        className="px-2 py-1 text-xs bg-red-500/20 hover:bg-red-500/40 text-red-400 border border-red-500/50 rounded font-mono hover:scale-110 transition-all"
                        title={t('historyClear')}
                      >
