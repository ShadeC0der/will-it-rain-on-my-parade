...
const translations = {
  es: {
    ...
    submitQuery: 'Consultar Clima',
    sendingQuery: 'Enviando consulta...',
    queryDetails: 'Detalles de la Consulta',
    targetDate: 'Fecha Objetivo',
    coordinates: 'Coordenadas',
    thresholds: 'Umbrales Configurados',
    meanBrierScore: 'Brier Score Promedio',
  ...
  en: {
    ...
    submitQuery: 'Query Weather',
    sendingQuery: 'Sending query...',
    queryDetails: 'Query Details',
    targetDate: 'Target Date',
    coordinates: 'Coordinates',
    thresholds: 'Configured Thresholds',
    meanBrierScore: 'Mean Brier Score',
